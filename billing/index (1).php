...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h4 class="text-center" style="color:green">Recipt Generater </h4>
         <h6 class="text-center"> RSR Rungta College of institue (bhilai)</h6>
               ...
               <table class="table" style="background-color:#f5f5f5;">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td><button id="add" class="btn btn-primary">Total</button></td>
                     </tr>
                  </tbody>
               </table>
